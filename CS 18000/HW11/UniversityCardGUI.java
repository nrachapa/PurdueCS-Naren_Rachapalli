...
public class UniversityCardGUI {
	...
	public static int showAgeInputDialog() {
		...
		int age = 0;
		do { 
			userChoice = JOptionPane.showInputDialog(null, "What is your age?", "University Card", JOptionPane.QUESTION_MESSAGE);
			if (userChoice == null || userChoice.isBlank()) {
				JOptionPane.showMessageDialog(null, "Please enter a valid number!", "University Card", JOptionPane.ERROR_MESSAGE);
			}
			try {
		...
		} while (userChoice == null || userChoice.isBlank());
	...
	public static String showEmailInputDialog() {
		String email;
		do {
			email = JOptionPane.showInputDialog(null, "What is your email?", "University Card", JOptionPane.QUESTION_MESSAGE);
			if (email == null || email.isBlank()) { 
				JOptionPane.showMessageDialog(null, "Please enter a valid email address!", "University Card", JOptionPane.ERROR_MESSAGE);
			}
	...
	public static String showClassStandingInputDialog() {
		String standing;
		do {
			standing = (String) JOptionPane.showInputDialog(null, "Select your class standing", "University Card", JOptionPane.QUESTION_MESSAGE, null, standingOptions, standingOptions[0]);
			if (standing == null || standing.isBlank()) {
				JOptionPane.showMessageDialog(null, "Choice cannot be empty!", "University Card", JOptionPane.ERROR_MESSAGE);
			}
		} while (standing == null || standing.isBlank());
	...
	public static void showPrintingDetailsDialog() {
		JOptionPane.showMessageDialog(null, "Printing Details to Terminal...", "University Card", JOptionPane.INFORMATION_MESSAGE);
	} //showPrintingDetailsDialog
} //UniversityCard
